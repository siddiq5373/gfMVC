<cfswitch expression="#thisTAG.executionmode#">
	<cfcase value="start">
		...
		<cfparam name="attributes.name" default="TimeField#request.DateFieldCount#" />
		...
		<script type="text/javascript" defer="defer"> jQuery(document).ready(function() { jQuery('###attributes.name#').ptTimeSelect(); }); </script>
		</cfoutput>
	</cfcase>
</cfswitch>